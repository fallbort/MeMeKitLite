...
// MARK: - Equatable
public extension MeMeSafeArray where Element: Equatable {
...
public extension MeMeSafeArray {
    ...
    static func +=(left: inout MeMeSafeArray, right: Element) {
        left.append(right)
    }
