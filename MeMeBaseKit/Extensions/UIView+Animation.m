...
//  MeMe
//
//  Created by puzhiguang on 12/06/2020.
...
- (void)jitterWithDuration:(CFTimeInterval)duration repeatCount: (double)repeatCount amplitude: (CGFloat)amplitude {
    ...
    animation.repeatCount = repeatCount;//抖动次数
