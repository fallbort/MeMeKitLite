...
public class MMVideoPermissionManager {
    ...
    public class func noCapturePermissionAlert(cancelCompletion: VoidBlock? = nil, confirmCompletion: VoidBlock? = nil) {
        let title = NELocalize.localizedString("System prevents MeMe to access camera", comment: "")
        let message = NELocalize.localizedString("To grant the permission: settings -> MeMe -> camera", comment: "")
