 ...
 */
@interface OrderedDictionaryOC<__covariant KeyType, __covariant ObjectType> : NSDictionary<KeyType, ObjectType>
 ...
 */
@interface MutableOrderedDictionaryOC<KeyType, ObjectType> : OrderedDictionaryOC<KeyType, ObjectType>
