...
@implementation SCCircleProgress
{
...
- (void)initialization {
    ...
    NSBundle *resourcesBundle = [NSBundle bundleWithPath:[mainBundle pathForResource:@"SCCircleProgress" ofType:@"bundle"]];
