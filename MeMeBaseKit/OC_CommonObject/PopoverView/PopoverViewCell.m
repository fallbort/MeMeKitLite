...
//    _button.contentHorizontalAlignment = UIControlContentHorizontalAlignmentLeft;
    ...
    bottomLine.backgroundColor = [[UIColor alloc] initWithWhite:1 alpha:0.4];
...
+ (UIColor *)bottomLineColorForStyle:(PopoverViewStyle)style {
    return style == PopoverViewStyleDefault ? [[UIColor alloc] initWithWhite:1 alpha:0.4] : [UIColor colorWithRed:0.4 green:0.4 blue:0.4 alpha:1.00];
}
...
- (void)setAction:(PopoverAction *)action {
    ...
    _button.titleEdgeInsets = action.image ? UIEdgeInsetsMake(0, PopoverViewCellTitleLeftEdge, 0, -PopoverViewCellTitleLeftEdge) : UIEdgeInsetsMake(0, 0, 0, 0);
}
