...
@property (nonatomic, copy) void (^indexChangedBlock)(NSInteger currentIndex,NSInteger oldIndex);
@property (nonatomic, copy) void (^layoutCardViewBlock)(UIView* view,NSInteger index);
