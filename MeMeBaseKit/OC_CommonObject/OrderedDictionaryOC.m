...
@property (nonatomic, readonly) OrderedDictionaryOC *root;

- (instancetype)initWithData:(NSData *)data  root:(OrderedDictionaryOC *)root;
...
- (instancetype)init
{
    if ((self = [super init]) && [self class] == [OrderedDictionaryOC class])
    {
        static OrderedDictionaryOC *singleton;
...
{
    return [[MutableOrderedDictionaryOC allocWithZone:zone] initWithDictionary:self];
}
...
@implementation MutableOrderedDictionaryOC
...
{
    return [(MutableOrderedDictionaryOC *)[self alloc] initWithCapacity:count];
}
...
{
    return [[OrderedDictionaryOC allocWithZone:zone] initWithDictionary:self];
}
...
- (instancetype)initWithData:(NSData *)data root:(OrderedDictionaryOC *)root
{
    if ((self = [super init]))
    {
        _root = [root isKindOfClass:[MutableOrderedDictionaryOC class]] ? root : nil;
...
- (void)parser:(NSXMLParser *)parser didStartElement:(nonnull NSString *)elementName namespaceURI:(__unused NSString *)namespaceURI qualifiedName:(__unused NSString *)qName attributes:(__unused NSDictionary<NSString *, NSString *> *)attributeDict
{
    if ([elementName isEqualToString:@"dict"])
    {
        if (_valueStack == nil)
        {
            _valueStack = [NSMutableArray arrayWithObject:_root ?: [MutableOrderedDictionaryOC dictionary]];
        }
        else
        {
            [_valueStack addObject:[MutableOrderedDictionaryOC dictionary]];
        }
    }
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(__unused NSString *)namespaceURI qualifiedName:(__unused NSString *)qName
{
    ...
    if ([top isKindOfClass:[MutableOrderedDictionaryOC class]])
    {
        NSString *key = _keyStack.lastObject;
        ((MutableOrderedDictionaryOC *)top)[key] = value;
